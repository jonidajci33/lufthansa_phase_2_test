...
import com.planningpoker.estimation.domain.DeckCategory;
...
/**
 * JPA entity mapped to the {@code estimation.deck_types} table.
 * Read-only replicated data from the Room Service.
 */
@Entity
@Table(name = "deck_types", schema = "estimation")
