package com.planningpoker.audit.infrastructure.config;
...
/**
 * Spring Security configuration for the Audit Service.
 * All /api/v1/audit/** endpoints require ADMIN role.
 * Internal and actuator endpoints are open.
 */
@Configuration
@EnableWebSecurity
